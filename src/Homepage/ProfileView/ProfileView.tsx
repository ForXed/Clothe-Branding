  ...
  const MAKERS_DB: Record<string, MakerProfile> = {
    'julian-v-studio': {
      ...
      products: [
        ...
        { id: 105, title: "Minimalist Crewneck", price: "$95", category: "Layering", stock: 25, img: "https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400" },
        { id: 106, title: "Wide Leg Trousers", price: "$165", category: "Bottoms", stock: 18, img: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=400" },
      ]
    },
    'me': {
      id: 'me',
      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.statsGrid}>
          ...
          <div className={styles.statCard}>
            ...
            <div className={styles.statValue}>{profileData.stats.rating > 0 ? profileData.stats.rating : '-'}</div>
          ...
          {!isOwnProfile && profileData.stats.responseTime && (
            <div className={styles.statCard}>
              ...
              <div className={styles.statValue}>{profileData.stats.responseTime}</div>
                  ...
                  {catalog.map(product => (
                    ...
                    >
                      <div className={styles.productImage}>
                        ...
                        {product.stock < 20 && (
                          <span className={styles.stockBadge}>Low Stock ({product.stock})</span>
                        )}
                      </div>

...
const SavedView = ({ savedItems, onSelect, toggleSaved, addToCart, updateSavedItems }) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.collectionsBar}>
        ...
        <button className={styles.addColBtn} onClick={() => setIsCreateModalOpen(true)}>
          + New Collection
        </button>
      </div>
            ...
            return (
              <div key={item.id} className={styles.card}>
                <div className={styles.imageContainer}>
                  ...
                  {/* UNSAVE */}
                  <button className={styles.unsaveBtn} onClick={(e) => { e.stopPropagation(); handleUnsave(item); }}>
                  ...
                  {/* QUICK CART */}
                  <button className={styles.quickCartBtn} onClick={(e) => { e.stopPropagation(); addToCart(item, 1, 'M'); }}>
